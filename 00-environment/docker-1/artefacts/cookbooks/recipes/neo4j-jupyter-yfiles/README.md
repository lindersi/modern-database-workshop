...
Navigate to <http://192.168.1.63:7474> and login as user `neo4j` and password `abc123abc123`.
...
Navigate to <http://192.168.1.63:28888> and login with the token specified above, i.e. `abc123!`.
