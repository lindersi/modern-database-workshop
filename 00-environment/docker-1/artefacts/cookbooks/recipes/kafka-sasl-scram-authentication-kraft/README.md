...
Navigate to AKHQ on <http://192.168.1.63:28107>.

## KaDeck

Navigate to KaDeck on <http://192.168.1.63:28313>, login as user `admin` with password `admin` and accept the license information.
