...
Navigate to the NiFi Registry: <http://192.168.1.63:19090/nifi-registry> and create a new bucket and name it `my-bucket`.

![](./images/create-bucket.png)

Navigate to NiFi <https://192.168.1.63:18080> and login as user `nifi` with password `1234567890ACD`.
