...
REST API documentation available [here](http://192.168.1.63:28257/api/schema/swagger).

Translate

```bash
curl 'http://192.168.1.63:28257/api/v4/translator?text=Hello&source=eng_Latn&target=spa_Latn'
```
