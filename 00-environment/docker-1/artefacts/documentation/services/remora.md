...
```bash
curl http://192.168.1.63:28256/consumers
```

Show specific consumer group information

```bash
curl http://192.168.1.63:28256/consumers/<consumer-group-id>
```

Show health

```bash
curl http://192.168.1.63:28256/health
```

Metrics

```bash
curl http://192.168.1.63:28256/metrics
```
