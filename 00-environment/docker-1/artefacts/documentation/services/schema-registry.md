...
curl -XPOST -H "Content-Type:application/json" -d"{\"schema\":$SCHEMA}" http://192.168.1.63:8081/subjects/$TOPIC-value/versions
```
...
```bash
export TOPIC=topicName
http http://192.168.1.63:8081/subjects/$TOPIC-value/versions/latest \
