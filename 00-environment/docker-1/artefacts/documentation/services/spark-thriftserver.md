...
Navigate to <http://192.168.1.63:28298> to view the Thriftserver UI.
...
Use `jdbc:hive2://192.168.1.63:28118` (external) or `jdbc:hive2://spark-thriftserver:10000` (internal) for the JDBC URL and use `org.apache.hive.jdbc.HiveDriver` for the class name. 
